	...
	return (
		<div className='flex justify-around items-center bg-black h-[5rem] text-white '>
			<div className='flex h-[100%]  w-[30%] items-center '>
				<input onChange={handleSearch} value={searchValue} className='text-black h-[70%] w-[70%]' type='text' />
			...
			<div className='flex justify-center bg-blue-400 h-[100%] w-[10%]'>
				<button onClick={() => handleOpenModal()}><BiLinkAlt size={"w-[2rem]"}/></button>
			</div>
